...
<body>
    ...
    <div id="main-wrapper">
        ...
        $view = $_GET['view'];
        $ret = "SELECT * FROM staff WHERE staff_id = '$view'  ";
                ...
                <div class="container-fluid">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href=""><?php echo $staff->staff_name; ?></a></li>
                        </ol>
                    </div>
                    <!-- row -->
                    <div class="row">
                                    ...
                                    <div class="profile-info">
                                        ...
                                        <div class="profile-details">
                                            <div class="profile-name px-3 pt-2">
                                                ...
                                                <br>
                                                <p>Access Level : <?php echo $staff->staff_rank; ?></p>
                                                <p>Phone Number : <?php echo $staff->staff_phone; ?></p>
                                                <p>Email : <?php echo $staff->staff_email; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="profile-tab">
                                            <div class="custom-tab-1">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item">
                                                        <a href="#change-password" data-toggle="tab" class="nav-link active">Change Password</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                    <div id="change-password" class="tab-pane fade tab-pane fade active show">
                                                        <div class="pt-3">
