...
if (isset($_POST['sign_in'])) {
    ...
    $stmt = $mysqli->prepare("SELECT staff_email, staff_password, staff_rank, staff_id FROM staff WHERE staff_email=? and staff_password=? ");
    $stmt->bind_param('ss', $staff_email, $staff_password);
    $stmt->execute();
    $stmt->bind_result($staff_email, $staff_password, $staff_rank, $staff_id);
    $rs = $stmt->fetch();

    if ($rs) {
        $_SESSION['staff_id'] = $staff_id;
        $_SESSION['staff_rank'] = $staff_rank;
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <h4 class="text-center mb-4 text-white">Sign In To Your Staff Account</h4>
                                        <form method="post">
                                            ...
                                            <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                                ...
                                                <div class="form-group">
                                                    <a class="text-white" href="staff_forgot_password">Forgot Password?</a>
                                                </div>
                                            </div>
