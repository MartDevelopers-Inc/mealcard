                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">System Reports</h3>
                                                    ...
                                                    <div class="row g-gs">
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_students" class="text-dark">
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_cashiers" class="text-dark">
                                                                    <div class="card-inner">
                                                                        <div class="card-title-group align-start mb-2">
                                                                            <div class="card-title">
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_meals" class="text-dark">
                                                                    <div class="card-inner">
                                                                        <div class="card-title-group align-start mb-2">
                                                                            <div class="card-title">
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_orders" class="text-dark">
                                                                    <div class="card-inner">
                                                                        <div class="card-title-group align-start mb-2">
                                                                            <div class="card-title">
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_meal_cards" class="text-dark">
                                                                    <div class="card-inner">
                                                                        <div class="card-title-group align-start mb-2">
                                                                            <div class="card-title">
                                                        ...
                                                        <div class="col-sm-4 col-lg-4 col-xxl-6">
                                                            <div class="card card-bordered">
                                                                <a href="reports_income" class="text-dark">
                                                                    <div class="card-inner">
                                                                        <div class="card-title-group align-start mb-2">
                                                                            <div class="card-title">
