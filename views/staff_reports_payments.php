                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Babershop Clients Reservations Payments Reports</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="export-data-table" class="display min-w850">
                                        <thead>
                                            <tr>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <b>Date Booked :</b> <?php echo date('d M Y g:ia', strtotime($payments->client_reservation_date_reserved)); ?>
                                                    </td>
                                                    <td>
