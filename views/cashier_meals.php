                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Cafe Meals</h2>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                    </div><!-- .nk-block-between -->
                                </div><!-- .nk-block-head -->
                                <div class="text-right">
                                    <a href="#add_modal" data-toggle="modal" class="btn btn-white btn-outline-light"><em class="icon ni ni-plus"></em><span>Add Meal</span></a>
                                </div>
                                <br>
                                <!-- Add Modal -->
                                                                                            ...
                                                                                            <div class="drodown">
                                                                                                ...
                                                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                                                    <ul class="link-list-opt no-bdr">
                                                                                                        <li><a href="cashier_meal?view=<?php echo $meals->meal_id; ?>"><em class="icon ni ni-focus"></em><span>Meal Details</span></a></li>
