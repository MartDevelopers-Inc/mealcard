...
<body>
    ...
    <?php require_once('../partials/landing_navbar.php');
    ...
    while ($system_settings = $res->fetch_object()) { ?>
                ...
                <div class="row align-items-center site-hero-inner justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <div class="mb-5 element-animate">
                            <img src="../public/landing_assets/images/banner_text_1.png" alt="Image placeholder" class="img-md-fluid">
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 pr-5">
                        ...
                        <p class="mb-5">
                            These are some of our experienced staffs offer <br>
                        </p>
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12 slider-wrap">
                                <div class="owl-carousel owl-theme no-nav js-carousel-1">
                                    ...
                                    <a href="sign_in" class="img-bg" style="background-image: url('../public/landing_assets/images/img_2.jpg')">
                                        <div class="text">
                                    ...
                                    <a href="sign_in" class="img-bg" style="background-image: url('../public/landing_assets/images/img_1.jpg')">
                                        <div class="text">
                                            <span class="icon custom-icon flaticon-scissors"></span>
                                            <h2>Beard Shaving</h2>
                                        </div>
                                    ...
                                    <a href="sign_in" class="img-bg last" style="background-image: url('../public/landing_assets/images/img_3.jpg')">
                                        <div class="text">
                                            <span class="icon custom-icon flaticon-scissors"></span>
                                            <h2>Cream &amp; Shampoo</h2>
                                        </div>
        ...
        <section class="section-cover cta" data-stellar-background-ratio="0.5" style="background-image: url(../public/landing_assets/images/big_image_2.jpg);">
            <div class="container">
                <div class="row justify-content-center align-items-center intro">
                    <div class="col-md-8 text-center element-animate">
                        ...
                        <p><a href="sign_up" class="btn btn-black">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </section>
