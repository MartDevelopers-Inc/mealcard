...
while ($sys = $res->fetch_object()) {
    ...
    <html>
        ...
        <body style="margin:1px;">
            <div class="footer">
                <hr>
                <i>' . $sys->sys_name . ' | ' . $sys->sys_tagine . ' Meal Cards Report Generated On ' . date('d, M Y') . '</i>
            </div>
        ...
        $html .=
            '
                <tr>
                    <td>' . $cnt . '</td>
                    <td width="100%">
                        Name: ' . $cards->user_name . ' <br>
                        Adm No: ' . $cards->user_number . '
                    </td>
                    <td width="90%">
                    ' . $cards->card_code_number . '
                    </td>
                    <td width="90%">
                    ' . $cards->card_status . '
                    </td>
                    <td width="90%">
                   Ksh ' . $cards->card_loaded_amount . '
                    </td>
    ...
    $dompdf->render();
    $dompdf->stream('Meal Card Reports', array("Attachment" => 1));
