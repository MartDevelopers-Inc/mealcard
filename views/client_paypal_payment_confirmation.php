...
/* Persist Paypal Payment Records To Payments */
$client_reservation_id = $_GET['reservation'];
$client_reservation_payment_status = "Paid";
$payment_id = $sys_gen_id;
$payment_client_id = $_GET['client'];
$payment_amount = $_GET['amount'];
$payment_confirmation_code = $sys_gen_paycode;
$payment_client_reservation_id = $_GET['reservation'];
...
if ($stmt1 && $stmt2) {
    /* Take me home */
    header("location:client_payments");
}
