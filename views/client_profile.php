...
if (isset($_POST['update_password'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($new_password != $confirm_password) {
            ...
            $query = "UPDATE client SET client_password =? WHERE client_id =?";
            $stmt = $mysqli->prepare($query);
            $rc = $stmt->bind_param('ss', $new_password, $client_id);
            $stmt->execute();
            if ($stmt) {
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php
        require_once('../partials/client_sidebar.php');
                                    ...
                                    <div class="profile-tab">
                                        <div class="custom-tab-1">
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item">
                                                    <a href="#booking_history" data-toggle="tab" class="nav-link active">Update Profile</a>
                                                </li>
                                                <li class="nav-item">
