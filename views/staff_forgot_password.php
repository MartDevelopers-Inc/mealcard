...
if (isset($_POST['Reset_Password'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM staff WHERE staff_email = '" . $staff_email . "' ");
    ...
    if ($num_rows > 0) {
        ...
        $rc = $stmt->bind_param('ss', $new_password, $staff_email);
        $stmt->execute();
        if ($stmt) {
            $_SESSION['staff_email'] = $staff_email;
            $success = "Password Reset" && header("refresh:1; url=staff_confirm_password");
        } else {
                                    ...
                                    <div class="auth-form">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                                ...
                                                <div class="form-group">
                                                    <a class="text-white" href="staff_login">Remembered Password? Sign In</a>
                                                </div>
                                            </div>
