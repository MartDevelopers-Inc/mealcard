...
if (isset($_GET['delete'])) {
    ...
    $stmt->execute();
    if ($stmt) {
        $success = "Booking Deleted " && header("refresh:1; url=client_booking");
    } else {
        $err = "Please Try Again Or Try Later";
    }
}
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6" style="display:none">
                                            ...
                                            <select class="form-control default-select" name="client_reservation_client_id" id="inputState">
                                                ...
                                                $ret = "SELECT * FROM client WHERE client_id = '$client_id'";
                                ...
                                <div class="table-responsive">
                                    <table class="data-table display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            JOIN  system_settings WHERE client_id = '$client_id'";
                                            $stmt = $mysqli->prepare($ret);
                                            $stmt->execute(); //ok
                                            $res = $stmt->get_result();
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="form-row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" required value="<?php echo $sys_gen_paycode; ?>" name="payment_confirmation_code" required class="form-control">
                                                                                    <!-- Hide This -->
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="text" value="<?php echo $reservations->service_rate; ?>" name="payment_amount" required class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <form action="<?php echo $reservations->sandbox_url; ?>" method="post">
                                                                            ...
                                                                            <input type='hidden' name='cancel_return' value='http://127.0.0.1/barbershop/views/client_booking'>
                                                                            <input type='hidden' name='return' value='http://127.0.0.1/barbershop/views/client_paypal_payment_confirmation?client=<?php echo $reservations->client_reservation_client_id; ?>&reservation=<?php echo $reservations->client_reservation_id; ?>&booking=<?php echo $reservations->client_reservation_client_id; ?>&amount=<?php echo $reservations->service_rate; ?>'>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center text-danger">
                                                                        ...
                                                                        <a href="client_booking?delete=<?php echo $reservations->client_reservation_id; ?>" class="text-center btn btn-danger"> Delete </a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
