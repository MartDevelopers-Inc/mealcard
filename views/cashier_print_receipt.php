                                        ...
                                        <div class="nk-block-head-content">
                                            <nav>
                                                <ul class="breadcrumb breadcrumb-arrow">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="cashier_payments">Payments</a></li>
                                            ...
                                            <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                                <div>
                                                    <h2 class="nk-block-title fw-normal">Cafe Meals Orders Payment Receipt</h2>
                                                </div>
