...
if (isset($_POST['sign_up'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($stmt) {
            $success = 'Welcome ' . $client_name . ',Your Account  Has Been Created, Proceed To Login ';
        } else {
                                    ...
                                    <div class="auth-form">
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="client_name" name="client_name" required class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label class="mb-1 text-white"><strong>Phone Number</strong></label>
                                                <input type="tel" name="client_phone" pattern="[+]{1}[0-9]{11,14}" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="text-center">
                                                <button type="submit" name="sign_up" class="btn bg-white text-primary btn-block">Sign Me Up</button>
                                            </div>
                                        </form>
                                        <div class="new-account mt-3">
                                            <p class="text-white">Already Have An Account? <a class="text-white" href="sign_in">Sign In</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
