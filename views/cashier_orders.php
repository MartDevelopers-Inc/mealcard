...
if (isset($_GET['delete'])) {
    ...
    if ($stmt) {
        $success = "Deleted" && header("refresh:1, cashier_orders");
    } else {
        $err = "Failed!, Please Try Again Later";
    }
}
                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h2 class="nk-block-title fw-normal">Cafe Meals Orders</h2>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                    </div><!-- .nk-block-between -->
                                </div><!-- .nk-block-head -->
                                <div class="text-right">
                                    <a href="#add_modal" data-toggle="modal" class="btn btn-white btn-outline-light"><em class="icon ni ni-plus"></em><span>Add Order</span></a>
                                </div>
                                <br>
                                <!-- Add Modal -->
                                                                                    ...
                                                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                        <div class="modal-content">
                                                                                            ...
                                                                                            <div class="modal-body text-center text-danger">
                                                                                                ...
                                                                                                <a href="cashier_orders?delete=<?php echo $orders->order_id; ?>" class="text-center btn btn-danger"> Delete </a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
