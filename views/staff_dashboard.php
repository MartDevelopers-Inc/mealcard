                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card">
                                    <div class="card-header border-0 pb-0">
                                        <h4 class="fs-20">Payment Logs</h4>
                                    </div>
                                    <div class="card-body pb-0 dz-scroll height630 loadmore-content" id="latestSalesContent">
                                        ...
                                        ?>
                                            ...
                                            <div class="pb-3 mb-3 border-bottom">
                                                <p class="font-w600">
                                                    <a href="staff_payments" class="text-success">
                                                ...
                                                <div class="d-flex align-items-end">
                                                    ...
                                                    <div class="mr-auto">
                                                        <h4 class="fs-14 mb-0">
                                                            <a href="staff_client?view=<?php echo $payments->client_id; ?>" class="text-black">
                                                                <?php echo $payments->client_name; ?>
                                                                Paid Ksh <?php echo $payments->service_rate; ?> For
                                                                <?php echo $payments->service_name; ?> On <?php echo date("d M Y g:ia", strtotime($payments->payment_date_posted)); ?>
                                                            </a>
                                                            <br>
                                                        </h4>
                                                    </div>
                                    ...
                                    <div class="card-footer text-center border-0">
                                        <a class="btn btn-primary btn-sm" href="staff_payments">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-4 col-xxl-4 col-lg-4 col-sm-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-end">
                                            <div>
                                                <p class="fs-14 mb-1">Babershop Staffs</p>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <p class="fs-14 mb-1">Loyal Clients</p>
                                                <span class="fs-35 text-black font-w600">
                                                    <?php echo $clients; ?>
                                                </span>
                                            </div>
                            ...
                            <div class="col-xl-4 col-xxl-4 col-lg-4 col-sm-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <p class="fs-14 mb-1">Services Offered</p>
                                                <span class="fs-35 text-black font-w600">
                                                    <?php echo $services; ?>
                                                </span>
                                            </div>
                            ...
                            <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <p class="fs-14 mb-1">Clients Bookings</p>
                                                <span class="fs-35 text-black font-w600">
                                                    <?php echo $bookings; ?>
                                                </span>
                                            </div>
                            ...
                            <div class="col-xl-6 col-xxl-6 col-lg-6 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <p class="fs-14 mb-1">Overall Revenue</p>
                                                <span class="fs-35 text-black font-w600">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header border-0 pb-sm-0 pb-5">
                                    <h4 class="fs-20">Recent Reservations</h4>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <b>Phone :</b> <?php echo $reservations->client_phone; ?><br>
