...
(1, 'Barbershop', 'Let your hair do the talking.', '+25479009312', 'martinezmbithi@gmail.com', '90126 Localhost', NULL, 'https://www.sandbox.paypal.com/cgi-bin/webscr');
...
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
